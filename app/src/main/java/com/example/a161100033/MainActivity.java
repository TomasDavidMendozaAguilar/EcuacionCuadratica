package com.example.a161100033;
        ...
        operacion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {// para encapsular un error de ingreso de datos como String en los EditText
                        ...
                        if (a1 == 0) {
                            ...
                            if (discriminante >= 0) {
                                if (discriminante == 0) {
                                    double x = -b1 / (2 * a1);
                                    AlertDialog.Builder alerta = new AlertDialog.Builder(MainActivity.this);
                                    alerta.setMessage("La raíz única es: "+x+"\n"+"Discriminante: "+discriminante).setNegativeButton("Aceptar", null).create().show();
                    ...
                    AlertDialog.Builder alerta = new AlertDialog.Builder(MainActivity.this);
                    alerta.setMessage("Haz ingresado un valor incorrecto (caracter, símbolo, etc.)").setNegativeButton("Aceptar", null).create().show();
